...
a persistence unit "NCapasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "NCapas/pom.xml":
...
artifact ("NCapas.war") is already built. You can build
